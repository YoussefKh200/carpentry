...
struct qt_meta_stringdata_CLASSClientsPageENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSClientsPageENDCLASS = QtMocHelpers::stringData(
    "ClientsPage",
    "onAdd",
    "",
    "onUpdate",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSClientsPageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ClientsPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSClientsPageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSClientsPageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSClientsPageENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ClientsPage, std::true_type>,
        // method 'onAdd'
...
void *ClientsPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSClientsPageENDCLASS.stringdata0))
