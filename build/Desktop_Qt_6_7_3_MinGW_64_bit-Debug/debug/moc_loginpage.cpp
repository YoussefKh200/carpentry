...
Q_CONSTINIT const QMetaObject LoginPage::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLoginPageENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<const UserData &, std::false_type>,
        // method 'onLoginClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onFaceLoginClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void LoginPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->loginSucceeded((*reinterpret_cast< std::add_pointer_t<UserData>>(_a[1]))); break;
        case 1: _t->onLoginClicked(); break;
        case 2: _t->onFaceLoginClicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (LoginPage::*)(const UserData & );
...
// SIGNAL 0
void LoginPage::loginSucceeded(const UserData & _t1)
{
