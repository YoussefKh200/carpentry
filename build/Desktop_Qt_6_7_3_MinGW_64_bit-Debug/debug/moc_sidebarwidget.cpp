...
constexpr auto qt_meta_stringdata_CLASSSidebarWidgetENDCLASS = QtMocHelpers::stringData(
    "SidebarWidget",
    "navigateTo",
    "",
    "index",
...
void SidebarWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &SidebarWidget::navigateTo; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &SidebarWidget::logoutRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SidebarWidget::navigateTo(int _t1)
{
...
// SIGNAL 1
void SidebarWidget::logoutRequested()
{
